 ...
 * @deprecated
 */
class RenderForm extends FormHelper
{
    ...
    /**
     * Retrieve the EscapeHtmlAttrHelper helper
     *
     * @return EscapeHtmlAttrHelper
     */
     ...
     * @param null|bool|string|\Zend\I18n\Translator\Translator $translator
     * @param null|string $textDomain
     * @return string|\Zork\Form\View\Helper\RenderForm
     */
